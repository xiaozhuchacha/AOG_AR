...
public class ARUWPMarkerEditor : Editor {
    ...
    void OnEnable() {
		...
		tracking_progress_holder = serializedObject.FindProperty("tracking_progress_text");
    }
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.PropertyField(tracking_progress_holder, new GUIContent("Tracking Progress Text"));
